    ...
    def master_read(self, data):
        ...
        if flag is not None:
            if flag in START_ALTERNATE_MODE:
                '''
                This code is executed when the child process switches the terminal into alternate mode.
                The line below assumes that the user has opened vim, and writes a message.
                '''
                self.write_master('IEntering special mode.\x1b')
            elif flag in END_ALTERNATE_MODE:
                '''
                This code is executed when the child process switches the terminal back out of alternate mode. 
                The line below assumes that the user has returned to the command prompt.
                '''
